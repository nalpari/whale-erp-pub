...
export default function PricingInfomation() {
  return (
    <div className="sub-wrap">
      <div className="sub-wrap-inner">
        <div className="sub-wrap-header">
          ...
          <div className="sub-header-s-tit">Whale ERP Pricing</div>
          <div className="sub-header-b-tit">
            <span className="bold">서비스 요금안내</span>
            <span>시작은 가볍게, 성장은 확실하게</span>
          </div>
          <div className="sub-header-desc">부담 없는 시작 꼭 필요한 기능들은 무료로 열려 있습니다.</div>
        </div>
