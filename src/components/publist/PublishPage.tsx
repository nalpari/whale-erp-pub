              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>요금안내</td>
                    <td>
                      <Link href={'/pricing-info'}>PricingInfomation.tsx</Link>
                    </td>
                    <td>PricingInfomation</td>
                    <td></td>
                    <td className="c red">2026-02-23</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>공지사항</td>
                    <td>
                      <Link href={'/before-notice'}>BeforeNoticeList.tsx</Link>
                    </td>
                    <td>IntroductionInquiry</td>
                    <td></td>
                    <td className="c red">2026-02-04</td>
                  ...
                  <tr>
                    <td>공통 코드 관리</td>
                    <td>
                      <Link href={'/commoncode'}>CommonCode.tsx</Link>
                    </td>
                    <td>CommonCode</td>
                    <td></td>
                    <td className="c red">2025-12-31</td>
                  ...
                  <tr>
                    <td>휴일 관리</td>
                    <td>
                      <Link href={'/dayoff'}>DayOff.tsx</Link>
                    </td>
                    <td>DayOff</td>
                    <td></td>
                    <td className="c red">2025-12-31</td>
                  ...
                  <tr>
                    <td>프로그램 관리</td>
                    <td>
                      <Link href={'/program'}>ProgramManage.tsx</Link>
                    </td>
                  ...
                  <tr>
                    <td>결제수단 등록 팝업</td>
                    <td>
                      <Link href={'/popup/paycreate'}>PaymentCreatePop.tsx</Link>
                    </td>
                  ...
                  <tr>
                    <td>문의하기 성공 팝업</td>
                    <td>
                      <Link href={'/popup/contact'}>ContactSuccessPop.tsx</Link>
                    </td>
                    <td>ContactSuccessPop</td>
                    <td></td>
                    <td className="c red">2026-01-28</td>
                  </tr>
                  <tr>
