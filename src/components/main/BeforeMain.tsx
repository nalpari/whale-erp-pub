...
export default function BeforeMain() {
  // Refs 객체로 관리
  const refs = {
    gsapWrap: useRef<HTMLDivElement>(null),
    section02: {
      smallTit: useRef<HTMLDivElement>(null),
      bigTit: useRef<HTMLDivElement>(null),
      desc: useRef<HTMLDivElement>(null),
      swiperWrap: useRef<HTMLDivElement>(null),
    },
    section03: {
      deviceInfoWrap: useRef<HTMLDivElement>(null),
      deviceItem: useRef<HTMLDivElement>(null),
      storeInfoItems: [useRef<HTMLDivElement>(null), useRef<HTMLDivElement>(null), useRef<HTMLDivElement>(null)],
    },
    section04: {
      deviceInfoWrap: useRef<HTMLDivElement>(null),
      deviceItem: useRef<HTMLDivElement>(null),
      deviceInfo: useRef<HTMLDivElement>(null),
    },
    section05: {
      headTit: useRef<HTMLDivElement>(null),
      headDesc: useRef<HTMLDivElement>(null),
      serviceList: useRef<HTMLDivElement>(null),
    },
  }
  ...
  useGSAP(
    () => {
      // 애니메이션 설정 배열
      const animations = [
        { ref: refs.gsapWrap.current, y: 150, opacity: 0, start: 'center center', end: '150% center' },
        { ref: refs.section02.smallTit.current, start: '-1200% center', end: '-200% center' },
        { ref: refs.section02.bigTit.current, start: '-250% center', end: '-10% center' },
        { ref: refs.section02.desc.current, start: '-800% center', end: '-200% center' },
        { ref: refs.section02.swiperWrap.current, start: '-40% center', end: '30% center' },
        { ref: refs.section03.deviceInfoWrap.current, start: '-60% center', end: '0% center' },
        { ref: refs.section03.deviceItem.current, start: '-60% center', end: '0% center' },
        { ref: refs.section03.storeInfoItems[0].current, start: '-160% center', end: '-30% center' },
        { ref: refs.section03.storeInfoItems[1].current, start: '-130% center', end: '-30% center' },
        { ref: refs.section03.storeInfoItems[2].current, start: '-100% center', end: '-30% center' },
        { ref: refs.section04.deviceInfoWrap.current, start: '-60% center', end: '20% center' },
        { ref: refs.section04.deviceItem.current, start: '-30% center', end: '20% center' },
        { ref: refs.section04.deviceInfo.current, start: '-250% center', end: '-100% center' },
        { ref: refs.section05.headTit.current, start: '-120% center', end: '0% center' },
        { ref: refs.section05.headDesc.current, start: '-600% center', end: '-300% center' },
        { ref: refs.section05.serviceList.current, start: '-100% center', end: '-30% center' },
      ]

      // 초기 상태 설정할 요소들 (첫 번째 요소 제외)
      const elementsToSet = animations
        .slice(1)
        .map((anim) => anim.ref)
        .filter(Boolean)
      gsap.set(elementsToSet, { y: 200, opacity: 0 })

      // 애니메이션 일괄 적용
      animations.forEach(({ ref, y = 0, opacity = 1, start, end }) => {
        if (!ref) return
    ...
    <div className="before-main">
      <section className="main-section01">
        ...
        <div className="section-inner">
          <div className="gsap-wrap" ref={refs.gsapWrap}>
      ...
      <section className="main-section02">
        <div className="section02-inner">
          <div className="section02-txt-wrap">
            ...
            <div className="section02-txt-b-tit" ref={refs.section02.bigTit}>
              <span>당신의 스마트한 선택</span>
              <span className="bold">매장에 필요한 업무를 한 곳에서!</span>
            </div>
            <div className="section02-txt-desc" ref={refs.section02.desc}>
              <span>매장의 직원 관리, 근무관리, 급여·정산, 매출과 손익 분석까지.</span>
              <span>WHALE ERP은 매장 운영에 필요한 모든 업무를 쉽고 간편하게 관리할 수 있습니다.</span>
            </div>
          </div>
          <div className="section02-swiper-wrap" ref={refs.section02.swiperWrap}>
            <Swiper
              slidesPerView={3}
              spaceBetween={235}
              className="mySwiper"
      ...
      <section className="main-section03">
        <div className="section-inner">
          <div className="device-info-wrap">
            <div className="device-comment" ref={refs.section03.deviceInfoWrap}>
            ...
            <div className="device-wrap">
              <div className="device-item" ref={refs.section03.deviceItem}>
                <Swiper
                  slidesPerView={1}
          ...
          <div className="store-info-list">
            <div className="store-info-item" ref={refs.section03.storeInfoItems[0]}>
            ...
            <div className="store-info-item " ref={refs.section03.storeInfoItems[1]}>
            ...
            <div className="store-info-item " ref={refs.section03.storeInfoItems[2]}>
      ...
      <section className="main-section04">
        <div className="section-inner">
          <div className="device-info-wrap mb">
            <div className="device-comment " ref={refs.section04.deviceInfoWrap}>
              <div className="comment-tit">
                <span>매장운영에 필요한</span>
            ...
            <div className="mb-device-wrap">
              <div className="mb-device-item" ref={refs.section04.deviceItem}>
                <Swiper
                  slidesPerView={1}
                  className="screen-swiper"
                  pagination={{
              ...
              <div className="mb-device-info" ref={refs.section04.deviceInfo}>
      ...
      <section className="main-section05">
        <div className="section05-inner">
          <div className="section05-head">
            ...
            <div className="head-desc" ref={refs.section05.headDesc}>
